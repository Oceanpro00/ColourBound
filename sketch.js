...
function waterfall(){
	...
	fill(paperCream);
	ellipse(880, 850 - waterfall_speeds.splash_count, 100, 100);
	ellipse(960, 850 - waterfall_speeds.splash_count, 100, 100);
	ellipse(1040, 850 - waterfall_speeds.splash_count, 100, 100);
	ellipse(1120, 850 - waterfall_speeds.splash_count, 100, 100);
	ellipse(920, 870 - waterfall_speeds.splash_count, 100, 100);
	ellipse(1000, 870 - waterfall_speeds.splash_count, 100, 100);
	ellipse(1080, 870 - waterfall_speeds.splash_count, 100, 100);

	fill(orangeLight);
	ellipse(880, 850 + waterfall_speeds.splash_count/2, 100, 100);
	ellipse(960, 850 + waterfall_speeds.splash_count/2, 100, 100);
	ellipse(1040, 850 + waterfall_speeds.splash_count/2, 100, 100);
	ellipse(1120, 850 + waterfall_speeds.splash_count/2, 100, 100);
	ellipse(920, 870 + waterfall_speeds.splash_count/2, 100, 100);
	ellipse(1000, 870 + waterfall_speeds.splash_count/2, 100, 100);
	ellipse(1080, 870 + waterfall_speeds.splash_count/2, 100, 100);
}
...
function grand_Sky()
{
    ...
    else
    {
        ...
        night_sky_alpha = map(sky_Spin, 108, 130, 0, 255)
    }
