...
function draw()
{
	...
	// Realizing here that just by painting in the backgound I will end up with a weird 
	// perspective issue so i need to erase but I cant as it erases everything...
	//Arches
	fill(132, 208, 207);
